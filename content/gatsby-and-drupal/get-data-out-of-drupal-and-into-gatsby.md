...
The gatsby-source-drupal plugin supports numerous additional configuration options. You can read all about them [in the documentation](https://www.gatsbyjs.org/packages/gatsby-source-drupal/). This includes:
